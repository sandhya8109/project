...
$userid=$_SESSION['id'];
    $msg=mysqli_query($con,"update users set fname='$fname',lname='$lname',contactno='$contact', location='$location', where id='$userid'");
    $msg=mysqli_query($con,"update menstrual_period_tracker set next_period_date='$next_period_date', where id='$userid'");
                     ...
                     <form method="post">
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       <th>Location</th>
                                       <td colspan="3"><input class="form-control" id="location" name="location" type="text" value="><?php echo $result['location'];?>" required /></td>
                                   </tr>
                                        <tr>
                                       <th>Reg. Date</th>
                                   ...
                                   <tr>
                                       <th>Period Detail</th>
                                       <td colspan="3"><input class="form-control" id="next_period_date" name="next_period_date" type="text" value="><?php echo $result['next_period_date'];?>" required /></td>
                                   </tr>
                                   <tr>
